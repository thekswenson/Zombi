...
class TestEvent(unittest.TestCase):
  ...
  def setUp(self, genome_file=TEST_GENOME_30_6):
    ...
    self.gss.run_f_debug(inject_events)
  
  def test_ngenes(self):
