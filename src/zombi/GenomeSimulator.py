...
class GenomeSimulator():
    ...
    def make_dummy_gene(self, species_tree_node: str,
                      time: int, family_mode = False, empirical_rates = False) -> Tuple[Gene, GeneFamily]:
        """
        This function is a bandaid for a greater problem were Zombi breaks if the first gene is not at 0.
        It creates a dummy gene at the first position just to help things run more smoothly. 
        ...
        #decide the strand size arbitrarily. 
        gene.orientation = "+"
